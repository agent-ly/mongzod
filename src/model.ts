...
import { buildIndexes, buildSchema } from "./class-to-zod/builder";
import type { JSONSchema } from "./zod-to-json-schema/mongodb-json-schema";
import { parseSchema } from "./zod-to-json-schema/parser";
...
export const buildModel = <T>(cls: Cls<T>): Model<T> => {
  const schema = buildSchema(cls);
